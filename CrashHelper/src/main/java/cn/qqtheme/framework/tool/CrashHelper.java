...
public final class CrashHelper {
    private static final String INTENT_EXTRA_STACK_TRACE = "GG.intent.EXTRA_STACK_TRACE";
    private static final String INTENT_EXTRA_URL = "GG.intent.EXTRA_URL";
    private static final String INTENT_ACTION_CRASH_ACTIVITY = "GG.intent.action.CRASH_ERROR";
    private static final String INTENT_ACTION_BROWSER_ACTIVITY = "GG.intent.action.WEB_BROWSER";
